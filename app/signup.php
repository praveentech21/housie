			...
			<div class="center-sign">
				<div class="panel card-sign">
					<div class="card-body" style="padding-top:0px;">
						<form action="input.php" method='post' autocomplete="off" onsubmit='return register();'>
							<div class="form-group mb-3" align="center">
								<img src="img/full_logo.jpg" alt="BO HOUSIE"/>
								<h3 class="user-name text-dark m-0" style='font-size:18px;padding-bottom:5px;'>NEW PLAYER SIGNIN</h3>
							...
							<div class="form-group mb-3">
								<div class="input-group">
									<input id="mobile" name="mobile" type="number" class="form-control" placeholder="Mobile Number" autocomplete="off" REQUIRED />
									<span class="input-group-append">
										<span class="input-group-text">
							...
							<div class="form-group mb-3">
								<div class="input-group">
									<input id="place" name="place" type="text" class="form-control" placeholder="Area / Locality"  autocomplete="off" REQUIRED />
									<span class="input-group-append">
										<span class="input-group-text">
							...
							<div class="form-group mb-3">
								<div class="input-group">
									<input id="city" name="city" type="text" class="form-control" placeholder="City / Town"  autocomplete="off" REQUIRED />
									<span class="input-group-append">
										<span class="input-group-text">
							...
							<div class="form-group mb-3">
								<div class="input-group">
									<input id="pin" name="pin" type="number" class="form-control" placeholder="4 Digit PIN (for Login)" MAXLENGTH='4' value='' autocomplete="off" REQUIRED/>
									<!-- <input id="pin" name="pin" type="password" class="form-control" placeholder="4 Digit PIN (for Login)" MAXLENGTH='4' value='' REQUIRED/> -->
									<span class="input-group-append">
										<span class="input-group-text">
