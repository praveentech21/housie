...
<?php 
   include "connect.php";
      $player_cnt=mysqli_query($conn, "SELECT count(*) FROM players;"); 		
					 ...
					 <table class="table table-responsive-md table-striped mb-0">
					   <thead>
                                        ...
                                        <?php
        								  ...
        								  $player_res=mysqli_query($conn, "SELECT player_name, place, pid, pin, status, points,  DATE_FORMAT(lastseen, '%W %e %M %h:%i %p') as dt FROM players order by lastseen desc;"); 		
