						...
						<form action="dashboard.php" method='post'>
							...
							<div class="form-group mb-3">
								<div class="input-group">
									<input id="pin" name="pin" type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;" class="form-control form-control-lg pin" placeholder="SECRET PIN" MAXLENGTH='6' style='color:transparent; text-shadow:0 0 2px rgba(0,0,0,0.1);' autocomplete="off"REQUIRED/>
