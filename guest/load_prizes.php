<?php
	...
	$prizes=mysqli_query($conn, "SELECT w.player_id, player_name, prize, DATE_FORMAT(timestamp, '%r'), timestamp FROM winners w, players p where w.player_id=p.player_id and gid=$gid order by timestamp desc;"); 		
	$r=0;
