...
if(isset($_GET['gid']))
{
    ...
    if(mysqli_num_rows($sponsor_res) > 0)
	  {
     	$sponsor=mysqli_fetch_assoc($sponsor_res);
		$sponsor1=$sponsor['sponsor1'];											  
        $sponsor2=$sponsor['sponsor2'];											  
        $sponsor3=$sponsor['sponsor3'];											  
	  }
	else
	  {
        $sponsor1="sponsor.png";											  
        $sponsor2="sponsor.png";											  
        $sponsor3="sponsor.png";											  
	  }
}
else
{
...
<html class="sidebar-light fixed sidebar-left-collapsed">
	        ...
	        <?php include "sidebar.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-lg-8 mb-4">
							...
							echo "<h5 align='center' style='color:#0088cc;text-transform:uppercase;'><b>".$row[1]." - ".$row[2]."</b></h5>";
                            ?>
				...
				<table border='1' class='table' id='ticket'>
				 ...
				 <script type="text/javascript">
                    var fullticket = <?php echo json_encode($final_ticket); ?>;
	...
	<!--			<div align='center'>Latest 10 Numbers</div> -->
		...
		<div class="face1" id='f1'><img src="img/<?php echo $sponsor1; ?>"></div>
		<div class="face2" id='f2'><img src="img/<?php echo $sponsor2; ?>"></div>
		<div class="face3" id='f3'><img src="img/<?php echo $sponsor3; ?>"></div>
		<div class="face4" id='f4'><img src="img/<?php echo $sponsor1; ?>"></div>
		<div class="face5" id='f5'><img src="img/<?php echo $sponsor2; ?>"></div>
		<div class="face6"><img src="img/<?php echo $sponsor3; ?>"></div>
		</div>
...
<div>
					  ...
					  <div class="owl-carousel owl-theme" data-plugin-carousel data-plugin-options='{ "dots": false, "autoplay": true, "autoplayTimeout": 3000, "loop": true, "margin": 10, "nav": true, "responsive": {"0":{"items":2 }, "600":{"items":2 }, "1000":{"items":2 } }  }'>
						...
						<div class="item"><img class="img-thumbnail" src="img/sponsors/mcr_web.jpg" alt=""></div>
					  						...
					  						<h4 align='center' style='color:#000000;'>NUMBER OF PLAYERS</h4>
						<h3 align='center' style='color:#FF0000;font-weight:bold;' id='loggedin'></h3> 					  
						...
						<section class="card mb-3">
								<header class="card-header">
									...
									<?php
									 ...
									 $comments=mysqli_query($conn, "SELECT count(*) FROM comments c , players p where p.pid=c.pid and gid=$gid;"); 		
...
<!--										<span class="badge badge-primary font-weight-normal va-middle p-2 mr-2" id='cmt_cnt'><?php //echo $cnt; ?></span> -->
		...
		<section class="card">
				<header class="card-header">
				<h2 class="card-title">NEW WINNER!</h2>
				</header>
		<div class="card-body">
			<div class="modal-wrapper">
				<div class="modal-text">
				  <h5 align='center'><b>Scratch The Below Card To See<br>The Winner & The Prize</b></h5>
      		      <div id='wrap' style='border:1px solid;'><div class='scratch'><img id='test' class='scratch-img' src='img/bvrmol_bg.jpg'><h6 align='center' id='winner_show' style='text-align:center;width:98%;margin-top:50px;'></h6></img></div></div>
				</div>
			</div>
		</div>
...
<script>
  ...
  source.onmessage = function(event) {
		...
		if(event.data != "PR")
		   {
			 scratchcard.reset();
             document.getElementById('winner_show').innerHTML = event.data;
			 $.magnificPopup.open({
					items: {
					src: '#swinner',
					type: 'inline',
				...
				if(sound == 1 && event.data != current)
					{
						...
						current = event.data;
              			timer(10);
						if(fullticket.indexOf(event.data) != -1)
						{
  ...
  function display_cube(dmsg)
	 {
		 ...
		 { 
           ...
           document.getElementById('f2').innerHTML = "<img src='img/<?php echo $sponsor1; ?>'>";		   
           document.getElementById('f3').innerHTML = "<span style='font-size:20px;margin-top:0px;'>SET</span>";		   
           document.getElementById('f4').innerHTML = "<img src='img/<?php echo $sponsor2; ?>'>";		   
...
<script data-main='scratch/test.js' src='https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.17/require.min.js'></script>
