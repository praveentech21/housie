		...
		<section class="body">
            ...
            <?php include "sidebar.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<div class='row'>
					<div class="col-xl-12">
					<h5 class="font-weight-semibold text-dark text-uppercase mb-3 mt-3">My Win Points</h5>
								...
								<div class="card-body">
									<table class="table table-responsive-md table-striped mb-0">
                                        ...
                                        <?php
        								  ...
        								  $game_res=mysqli_query($conn, "SELECT gid, win_type, prize, points, DATE_FORMAT(timestamp, '%W %e %M %h:%i %p') as tm FROM winners where pid=$pid order by timestamp desc;"); 		
                                          $sno=1; 
										  $total=0;
          								  while($row=mysqli_fetch_array($game_res))
										    {
											 ...
											 echo "<td>Won <b>".$prize."</b> in Game No: <a href='game.php?gid=".$row['gid']."'><b>".$row['gid']."</b></a></td>";
											 echo "<td>".$row['tm']."</td>";
											 echo "</tr>";
											 $sno++;
											 $total += $row['points'];
										    }											
                                        echo "<tr><th>Total:</th><td colspan='3'><b>".$total."</b> Purchase Points - You can shop with these points in Bhimavaram Online!</td>";
										?>  
